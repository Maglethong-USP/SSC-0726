# IO.Swagger - the C# library for the Contacts API
...
------------ | ------------- | ------------- | -------------
*DiceApi* | [**ApiDiceGet**](docs/DiceApi.md#apidiceget) | **GET** /api/dice | 
*ValuesApi* | [**ApiValuesByIdDelete**](docs/ValuesApi.md#apivaluesbyiddelete) | **DELETE** /api/Values/{id} | 
*ValuesApi* | [**ApiValuesByIdGet**](docs/ValuesApi.md#apivaluesbyidget) | **GET** /api/Values/{id} | 
